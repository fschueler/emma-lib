...
class DVectorSpec extends BaseLibSpec {
  ...
  it should "compute the l2 norm" in pending

  it should "compute the squared distance" in pending

  it should "compute pairwise min between two DVectors" in pending

  it should "compute pairwise max between two DVectors" in pending
